        ...
        <div className="flex flex-col gap-15 md:gap-5 md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 md:pr-12">
            ...
            <p className="text-gray-600 mb-8 text-lg leading-relaxed">
              Tim Ruang Keluarga siap mendukung langkah Anda dalam membangun rumah tangga dan mendampingi buah hati tumbuh optimal.
            </p>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center p-4 bg-gray-50 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@ruangkeluarga.com</p>
                </div>
              </div>
            </div>
          </div>
